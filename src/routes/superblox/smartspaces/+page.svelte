<script>
  ...
  import smartRefineries from "$lib/smartRefineries.png";
  import smartFactories from "$lib/smartFactories.png";
  import smartFarms from "$lib/smartFarms.png";
  import smartHomes from "$lib/smartHomes.png";
  import smartLogistics from "$lib/smartLogistics.png";
  import TheTinkerBloXUSP from "$lib/TheTinkerBloXUSP.svg";
  import ss1 from "$lib/ss1.svg";
  import ss2 from "$lib/ss2.png";
  import ss3 from "$lib/ss3.png";
  import ss4 from "$lib/ss4.png";
  import ss5 from "$lib/ss5.png";
  import as1 from "$lib/as1.png";
  import as2 from "$lib/as2.png";
  import as3 from "$lib/as3.png";
  import as4 from "$lib/as4.png";
  import as5 from "$lib/as5.png";
  ...
  let sections = [
    { id: "safe", text: "SMART Spaces for you" },
...
>
  <div class=" flex w-full flex-col items-start gap-2 p-10 md:flex-row">
    <div class=" w-full md:ml-40 md:w-1/3">
      ...
      >
        Build an autonomous & sustainable AIoT eco-system of your living & work
        spaces.
      </p>
    </div>
  </div>
...
>
  <div class="m-auto flex max-w-6xl flex-col items-center gap-2">
    ...
    >
      There used to be a time when the spaces we lived in, travelled in, worked
      in and played in, were only that – spaces. Interactions, if any, were
      limited, unidirectional and mostly, boring. <br /> <br /> With digital
      technologies becoming mainstream, this has changed drastically. Today,
      it’s not unimaginable for homes to interact with its inhabitants, for
      offices to proactively care for the environment of its workers, for
      factories to take responsibility of the safety & security of its men &
      machines, for greenhouses to adapt to the needs of its plant life, and for
      all of the above to be conscious of their role in creating a sustainable
      and eco-friendly environment <br /> <br />
      <span
      ...
      >
        @TinkerBloX, we believe in creating SAFE – Sustainable, Autonomous,
        Federated, Efficient – spaces for all of the aforementioned scenarios
        leveraging on our Device Native Edge-Centric suite of AIoT products…
      </span>
    </p>
  </div>
</section>
    ...
    >
      <div class=" flex w-96 flex-col items-center gap-4 p-8">
        ...
        <p class="w-80 text-center font-normal text-white">
          Leverage AIoT to meet regulatory requirements for health, well-being &
      ...
      <div class=" flex w-96 flex-col items-center gap-4 p-8">
        ...
        <p class="w-80 text-center font-normal text-white">
          Real-time 🡪 predictive 🡪 prescriptive management of O&G spaces for
          ~ZERO hazards
        </p>
      </div>
      ...
      <div class=" flex w-96 flex-col items-center gap-4 p-8">
        ...
        <p class="w-80 text-center font-normal text-white">
          Optimize/minimize the overall efficiency of your factory space across
  ...
  {#if selected === "Autonomous"}
    ...
    >
      <div class=" flex w-96 flex-col items-center gap-4 p-8">
        ...
        <p class="w-80 text-center font-normal text-white">
          IoT-ize your utility assets to ensure 360o value for your commercial
          spaces
        </p>
      </div>
      ...
      <div class=" flex w-96 flex-col items-center gap-4 p-8">
        ...
        <p class="w-80 text-center font-normal text-white">
          Create autonomous closed-loop systems for maximum efficiency & safety
          of your refinery
        </p>
      </div>
      ...
      <div class=" flex w-96 flex-col items-center gap-4 p-8">
        ...
        <p class="w-80 text-center font-normal text-white">
          Build & manage autonomous sites with the power of private 5G & the
          network edge
        </p>
      </div>
  ...
  {#if selected === "Federated"}
    ...
    >
      <div class=" flex w-96 flex-col items-center gap-4 p-8">
        ...
        <p class="w-80 text-center font-normal text-white">
          Realize symbiosis & circularity across all systems & processes of
          standalone / networked buildings
        </p>
      </div>
      ...
      <div class=" flex w-96 flex-col items-center gap-4 p-8">
        ...
        <p class="w-80 text-center font-normal text-white">
          Resilient yet fungible assets & systems boosted by distributed compute
          & supervised control
        </p>
      </div>
      ...
      <div class=" flex w-96 flex-col items-center gap-4 p-8">
        ...
        <p class="w-80 text-center font-normal text-white">
          Balance autonomy with federation for a truly digital factory at your
          fingertips
        </p>
      </div>
      ...
      <div class=" flex w-96 flex-col items-center gap-4 p-8">
        ...
        <p class="w-80 text-center font-normal text-white">
          Reimagine farming with digital disruptions across the agricultural
          value-chain
        </p>
      </div>
      ...
      <div class=" flex w-96 flex-col items-center gap-4 p-8">
        ...
        <p class="w-80 text-center font-normal text-white">
          Multi-modal transport & multi-network transactions unified to form a
          circular ecosystem
        </p>
      </div>
  ...
  {#if selected === "Efficient"}
    ...
    >
      <div class=" flex w-96 flex-col items-center gap-4 p-8">
        ...
        <p class="w-80 text-center font-normal text-white">
          Target margin expansion & improve free-cash-flow through automation &
          green-tech
        </p>
      </div>
      ...
      <div class=" flex w-96 flex-col items-center gap-4 p-8">
        ...
        <p class="w-80 text-center font-normal text-white">
          Maximize the value of your O&G resources be it onshore, offshore or
          unconventionals
        </p>
      </div>
      ...
      <div class=" flex w-96 flex-col items-center gap-4 p-8">
        ...
        <p class="w-80 text-center font-normal text-white">
          Target transparency & control of your factory utilities & ageing infra
      ...
      <div class=" flex w-96 flex-col items-center gap-4 p-8">
        ...
        <p class="w-80 text-center font-normal text-white">
          From maximizing yield to optimizing resources (esp. water & energy),
          AIoT enhances farm ops
        </p>
      </div>
      ...
      <div class=" flex w-96 flex-col items-center gap-4 p-8">
        ...
        <p class="w-80 text-center font-normal text-white">
          Engage drone fleets for uber-efficient safety & security management of
          your spaces
        </p>
      </div>
  ...
  <div class=" m-auto flex w-full max-w-5xl flex-wrap">
    ...
    >
      <div class=" flex h-full w-64 flex-col items-center bg-[#E9E9E9]">
        ...
        <img class="  w-64 hover:scale-105" src={smartBuildings} alt="" />
        <p class=" p-2 text-center text-black/40">
          Embrace AIoT to realize smart sustainable humane buildings with a
          “life” of their own
        </p>
      </div>
    </div>
    ...
    >
      <div class=" flex h-full w-64 flex-col items-center bg-[#E9E9E9]">
        ...
        <img class="  w-64 hover:scale-105" src={smartRefineries} alt="" />
        <p class=" p-2 text-center text-black/40">
          O&G spaces need to be safe, secure, optimum & responsive…now, more
          than ever
        </p>
      </div>
    </div>
    ...
    >
      <div class=" flex h-full w-64 flex-col items-center bg-[#E9E9E9]">
        ...
        <img class="  w-64 hover:scale-105" src={smartFactories} alt="" />
        <p class=" p-2 text-center text-black/40">
          Shift your ESG initiatives into high gear powered by AIoT products &
          services
        </p>
      </div>
    </div>
    ...
    >
      <div class=" flex h-full w-64 flex-col items-center bg-[#E9E9E9]">
        ...
        <img class="  w-64 hover:scale-105" src={smartFarms} alt="" />
        <p class=" p-2 text-center text-black/40">
          Explore Farms that are autonomous federated sustainable local
          eco-systems
        </p>
      </div>
    </div>
    ...
    >
      <div class=" flex h-full w-64 flex-col items-center bg-[#E9E9E9]">
        ...
        <img class="  w-64 hover:scale-105" src={smartHomes} alt="" />
        <p class=" p-2 text-center text-black/40">
          Transform your living spaces into pro-active intelligent experiential
          identities
        </p>
      </div>
    </div>
    ...
    >
      <div class=" flex h-full w-64 flex-col items-center bg-[#E9E9E9]">
        ...
        <img class="  w-64 hover:scale-105" src={smartLogistics} alt="" />
        <p class=" p-2 text-center text-black/40">
          Scope III is perhaps the most impactful sustainability aspect of the
