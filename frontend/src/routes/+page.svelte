...
<section
	...
	<div
		...
		<span>|</span>
		<span class=" w-52 md:w-60">Deploy & Accelerate X-as-a-Service</span>
	</div>
</section>
...
<section
	...
	<div
		class="m-auto flex w-full max-w-screen-2xl items-center justify-center gap-3 px-3 py-20 md:gap-14 md:px-2 md:py-44">
		<div class=" w-10/12 md:w-2/5">
			<h3 class="text-3xl font-medium text-secondary md:text-4xl">
				Everyone believes their IoT problem is unique...
			</h3>
			<br />
			<h3 class="text-4xl font-bold text-info md:text-5xl">Everyone is right!</h3>
		</div>
	</div>
	<div>
...
<section
	...
	class=" zw-full bg-center-left flex h-fit min-h-[calc(100vh-4rem)] flex-col items-center bg-center bg-no-repeat">
